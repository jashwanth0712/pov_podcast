    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <header className="sticky top-0 z-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-4">
          <div className="flex items-center justify-between rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 px-4 sm:px-6 py-3 shadow-2xl">
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 space-y-16">
        ...
        <section aria-labelledby="historical-scenarios-heading">
          <div className="flex flex-col gap-6 items-center sm:items-end text-center sm:text-left sm:flex-row sm:justify-between mb-8">
            <div>
              <h2
        ...
        <section aria-labelledby="your-scenarios-heading">
          <div className="flex flex-col gap-4 items-center text-center sm:flex-row sm:items-center sm:justify-between sm:text-left mb-8">
            <div>
              <h2
